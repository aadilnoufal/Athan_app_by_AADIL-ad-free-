...
Write-Host ""
Write-Host "Step 3: Verifying Android setup..." -ForegroundColor Yellow
...
if (Test-Path ".\android\gradlew") {
    ...
    Write-Host "⚠️ Gradle wrapper not found, will be generated during prebuild" -ForegroundColor Yellow
}

Write-Host ""
Write-Host "Step 4: Prebuild Android project..." -ForegroundColor Yellow
npx expo prebuild --platform android --clean

Write-Host ""
Write-Host "Step 5: Building APK with EAS Build (Development)..." -ForegroundColor Yellow
Write-Host "🔄 Starting development build..." -ForegroundColor Cyan
eas build --platform android --profile development --non-interactive

Write-Host ""
Write-Host "Step 6: Building AAB (App Bundle) for Play Store..." -ForegroundColor Yellow
...
Write-Host "- Gradle wrapper properly configured"
Write-Host ""
